<footer x-data="{ screenWidth: window.innerWidth }" x-resize="screenWidth = $width" class="footer font-sans tracking-wide px-8 py-12">
            <div class="max-w-7xl mx-auto   grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-x-6 gap-y-10">
                <div>
                ...
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open || screenWidth >= 768" x-collapse.duration.1000ms @click.away="open = false" >
                        <ul class="mt-6 space-y-5">
                            <li>
                                <a href="/booking" wire:navigate class='hover:text-white text-gray-300 text-sm'>Stand buchen</a>
                            </li>
                            <li>
                                <a  href="/prices" wire:navigate  class='hover:text-white text-gray-300 text-sm'>Preise</a>
                            </li>
                            <li>
                                <a  href="/products" wire:navigate  class='hover:text-white text-gray-300 text-sm'>Produkte</a>
                            </li>  
                        </ul>
                    </div>
                </div>
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open || screenWidth >= 768" x-collapse.duration.1000ms @click.away="open = false" >
                        <ul class="space-y-5 mt-6">
                            <li>
                                <a href="/aboutus" wire:navigate  class='hover:text-white text-gray-300 text-sm'>Über uns</a>
                            </li>
                            <li>
                                <a  href="/howto" wire:navigate  class='hover:text-white text-gray-300 text-sm'>So funktionierts</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div x-data="{ open: false }" x-intersect.full.once="setTimeout(() => {open = true;}, 1000);">
                    ...
                    <div x-show="open || screenWidth >= 768" x-collapse.duration.1000ms @click.away="open = false"  >
                        <ul class="space-y-5 mt-6 ">
                            <li>
                            <a href='/faqs' wire:navigate  class='hover:text-white text-gray-300 text-sm'>FAQ</a>
                            </li>
                            <li>
                            <a  href="/contact" wire:navigate  class='hover:text-white text-gray-300 text-sm'>Kontakt</a>
                            </li>
                        </ul>
                    </div>
                </div>
            </div>
            <hr class="max-w-7xl mx-auto  my-10 border-gray-400" />
            <div class="max-w-7xl mx-auto  flex flex-wrap max-md:flex-col gap-4">
                <div>
                    <ul class="md:flex md:space-x-6 max-md:space-y-2 max-sm:grid max-sm:grid-flow-row-dense max-sm:grid-cols-3 max-sm:grid-rows-3">
                        <li class="max-sm:col-span-2">
                            <a href="/termsandconditions" wire:navigate class='hover:text-white text-gray-300 text-sm '>AGB's</a>
                        </li>
                        <li class="max-sm:col-span-2">
                            <a href="/privacypolicy" wire:navigate class='hover:text-white text-gray-300 text-sm '>Datenschutz</a>
                        </li>
                        <li class="max-sm:col-span-2">
                            <a href="/imprint" wire:navigate class='hover:text-white text-gray-300 text-sm '>Impressum</a>
                        </li>
                        <li class="max-sm:inline-flex max-sm:place-self-end max-sm:w-max" >
                            <a class=""  href='https://www.facebook.com/share/187uXEMmkP/?mibextid=LQQJ4d' target="_blank">
                        ...
                        <li class="max-sm:inline-flex max-sm:place-self-end max-sm:w-max" >
                            <a class="" href='https://www.instagram.com/minifinds.de/profilecard/?igsh=bzd1eW5ybm82bmo5' target="_blank">
                ...
                <p class='text-gray-300 text-sm md:ml-auto'>&copy; {{ date("Y") }} MiniFinds GbR. Alle Rechte vorbehalten.</p>
            </div>
</footer>
