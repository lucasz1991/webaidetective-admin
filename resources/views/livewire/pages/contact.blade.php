        ...
        <div class=" max-w-7xl px-6 md:px-12 mx-auto h-0">
            ...
            <div class="mb-12 w-full md:w-4/12  px-6 md:px-3 lg:px-6">
                ...
                <p class="text-gray-600 leading-relaxed">
                    Wir freuen uns, von dir zu hören! Wenn du Fragen zu unseren Produkten hast, Unterstützung bei der Buchung eines Regals benötigst oder einfach mehr über unsere Dienstleistungen erfahren möchtest, stehen wir dir gerne zur Verfügung.
                </p>
            </div>
                <div class="flex items-center grow-0 basis-auto">
                    <div class="flex flex-wrap h-min justify-center">
                        <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-5/12 md:px-3 ">
                        ...
                        <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-5/12 md:px-3 ">
